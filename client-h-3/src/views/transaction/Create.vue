                    ...
                    <div class="card-body">
                         <form @submit.prevent="store()">
                             <div class="mb-3">
                                 ...
                                 <input type="text" name="" id="" class="form-control" v-model="transaction.title">
                             ...
                             <div class="mb-3">
                                 ...
                                 <input type="number" name="" id="" class="form-control" v-model="transaction.amount">
                             ...
                             <div class="mb-3">
                                 ...
                                 <input type="text" name="" id="" class="form-control" placeholder="yyyy-mm-dd hh:mm:ss" v-model="transaction.time">
